...
| STAGE-001-002 | Frontend skeleton                                     | Not Started |
| STAGE-001-003 | CI + Code Review Graph + Dependabot                   | Not Started |
| STAGE-001-004 | SQLite + Alembic + first migration                    | Not Started |
| STAGE-001-005 | Encrypted secrets store                               | Not Started |
