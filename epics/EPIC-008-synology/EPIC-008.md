...
| STAGE-008-007 | DSM syslog forwarding setup (instructions documented); vector source addition; failed-login pattern produces `SshFailedLoginBurst`-like rules scoped to Synology source |
...
| STAGE-008-009 | Synology integration UI panel: volumes, drive temperatures, SMART status grid, backup-job timeline, camera status grid |
