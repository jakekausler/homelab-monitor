"""Tests for the shared Pi-hole parsing helpers -- as_float / emit_numeric."""
...
def _ctx(writer: InMemoryMetricsWriter) -> CollectorContext:
    ...
    return CollectorContext(
        config=CollectorConfig(name="pihole_parsing", interval_seconds=30, timeout_seconds=15),
        ...
        log=structlog.get_logger().bind(collector="pihole_parsing"),  # pyright: ignore[reportArgumentType]
        pihole=None,
    )
