...
export function ModelsDebugPage(): JSX.Element {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      {/* Description block */}
      <div data-testid="models-description" className="px-4 pt-4">
        <h1 className="text-2xl font-semibold tracking-tight">Drain Models</h1>
        <p className="text-sm text-muted-foreground">
          Inspect the per-service Drain parser state used to cluster raw log lines into signatures.
        </p>
      </div>
          ...
          <div className="min-h-0 flex-1 overflow-auto">
            {selectedKey === null ? (
              ...
              <>
                ...
                >
                  Counts reflect log lines ingested by drain while it has been running — not full
                  log history. <code className="font-mono">last seen</code> is shared across all
                  templates in a model.
                </p>
                      ...
                      >
                        <div className="space-y-1">
                          ...
                          <div className="grid grid-cols-2 gap-1 text-muted-foreground">
                            ...
                            <div>
                              Last: {formatRelative(new Date(t.last_seen_ts).toISOString())}
                            </div>
                          </div>
                          <div className="pt-1">
                            <TemplateActions
